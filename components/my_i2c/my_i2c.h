...
//esp_err_t my_i2c_init(i2c_master_bus_handle_t *bus_handle,
//					  i2c_master_dev_handle_t *dev_handle, int sda_io,
//					  int scl_io, int freq_hz, uint8_t dev_addr);
esp_err_t my_i2c_add_dev(i2c_master_bus_handle_t *bus_handle,
						i2c_master_dev_handle_t *dev_handle, int freq_hz,
						uint8_t dev_addr);
